  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-900 mb-8">
        Welcome to Component Showcase
      </h1>
      
      <p className="text-lg text-gray-600 mb-8">
        This is a showcase repository where I create and demonstrate various React components 
        with different use cases and usage patterns.
      </p>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          ...
          <p className="text-gray-600 mb-4">
            An accessible accordion component with single and multiple expansion modes, 
